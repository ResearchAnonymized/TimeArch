...
import { parseEmailWebhookPayload, WebhookError, verifyEmailWebhookRequest, getEmailApiKey } from '../_shared/email-platform.ts'
...
const ROOT_DOMAIN = "sda-assistant.com"
const FROM_DOMAIN = "notify.sda-assistant.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = Deno.env.get("SITE_URL") ?? "https://example.com"
